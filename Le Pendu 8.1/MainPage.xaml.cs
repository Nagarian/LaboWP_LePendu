...
using Le_Pendu_8._1.Resources;
using Windows.Storage;
using System.IO;
using System.Text;
using System.Windows.Media.Imaging;

namespace Le_Pendu_8._1
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void TextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (MyTextBox.Text.Length > 0)
            {
                ...
                // En Windows Phone 8.0 mettre le focus sur la page à la place du TextBox permet de cacher le clavier
                this.Focus();
            }
        }
        ...
        public void VerifierVictoire()
        {
            ...
            if (compteurErreur >= 6)
            {
                ...
                // Si vous avez choisi une application Windows Phone 8.0 nous utilisons cette méthode pour afficher un message
                MessageBox.Show("Vous êtes mort !");

                // Et si vous ne savez pas quel version de windows phone vous faites, regardez dans les propriétés du projet.
            }
            else
            {
                ...
                {
                    MyTextBox.IsEnabled = false;
                    MessageBox.Show("Vous avez gagné ! =D");
                }
            }
        }
