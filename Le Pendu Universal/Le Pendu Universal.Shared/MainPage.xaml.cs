    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void TextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if (MyTextBox.Text.Length > 0)
            {
                ...
                // Afin de garder la disparité entre WP et W8 sur la disparition du clavier, nous mettons en place une condition de précompilation
                // Il s'agit d'une condition qui permet de définir suivant la condition si on doit inclure le bout de code ou pas.
                // Ici WINDOWS_PHONE_APP est définit uniquement dans le projet universel du côté WindowsPhone (voir dans les Properties du projet > Build > général
